import { ObjectInfo } from "../ts-type.js";
import { NUMBER_FORMAT_DISPLAY, NUMBER_FORMAT_OPTIONS, NumberFormat } from "./number-format.enum.js";
...
function numberFormatSuffix(value?: number | null, decimals: number = 2): NumberFormatResult | null {
  ...
  const suffixes: NumberFormat[] = NUMBER_FORMAT_OPTIONS;
...
function trimDecimals(num: number, maxDecimals: number): string {
